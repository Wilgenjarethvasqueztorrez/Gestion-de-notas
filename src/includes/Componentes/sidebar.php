...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li>
            <a href="<?php echo BASE_URL; ?>pages/alumno.php"
        ...
        <li>
            <a href="<?php echo BASE_URL; ?>pages/clase.php"
        ...
        <li>
            <a href="<?php echo BASE_URL; ?>pages/parcial.php"
        ...
        <li>
            <a href="<?php echo BASE_URL; ?>pages/year.php"
        ...
        <li>
            <a href="<?php echo BASE_URL; ?>pages/matricula.php"
                class="<?php echo basename($_SERVER['PHP_SELF']) == 'matricula.php' ? 'active' : ''; ?>">
        ...
        <li>
            <a href="<?php echo BASE_URL; ?>pages/nota.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'nota.php' ? 'active' : ''; ?>">
