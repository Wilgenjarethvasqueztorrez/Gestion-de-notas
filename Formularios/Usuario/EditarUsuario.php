            ...
            <form action="../../CRUD/Usuario/editarUsuario.php" method="post">  
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select form-control-custom" name="RolSistema" required>  
                        ...
                        <option value="Profesor" <?php echo ($row['rol_sistema'] == 'Profesor') ? 'selected' : ''; ?>>👨‍🏫 Profesor</option>  
                        <option value="Estudiante" <?php echo ($row['rol_sistema'] == 'Estudiante') ? 'selected' : ''; ?>>👨‍🎓 Estudiante</option>  
                    </select>  
                </div>
