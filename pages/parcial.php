...
<body>
  ...
  <main class="container mt-4">
    ...
    <div class="text-end mb-3">
      <a href="<?php echo BASE_URL; ?>Formularios/Parciales/AgregarParcial.php" class="btn btn-success">
       ...
       ");
          ...
          ?>
            <tr>
              ...
              <td class="acciones">
                <a href="<?php echo BASE_URL; ?>Formularios/Parciales/EditarParcial.php?Id=<?php echo $resultado['parcial_id']; ?>"
                  class="btn btn-warning btn-sm">
                  <i class="bi bi-pencil"></i> Editar
                </a>
                <a href="<?php echo BASE_URL; ?>CRUD/Parciales/eliminarParcial.php?Id=<?php echo $resultado['parcial_id']; ?>"
