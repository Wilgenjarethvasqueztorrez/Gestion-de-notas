...
<body>
  ...
  <main class="container mt-4">
    ...
    <div class="text-end mb-3">
      <a href="Formularios/Clases/AgregarClase.php" class="btn btn-success">
      ...
      ");
          ...
          ?>
            <tr>
              ...
              <td class="acciones">
                <a href="Formularios/Clases/EditarClase.php?Id=<?php echo $resultado['id']; ?>"
                  class="btn btn-warning btn-sm">
                  <i class="bi bi-pencil"></i> Editar
                </a>
                <a href="CRUD/Clases/eliminarClase.php?Id=<?php echo $resultado['id']; ?>"
